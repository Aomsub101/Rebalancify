# Component 8 — AI Research Hub: As-Built PRD
...
**Forced refresh**: If the user requests refresh, a new `research_sessions` row is inserted with `refreshed_at` populated. The old row is never updated.
...
| `GET /api/knowledge/corpus-size` | Returns current storage size for capacity warning |
...
| Sub-Component | File |
|---|---|
| LLM Settings Section | `01_llm_settings_section.md` |
| LLM Key Gate | `02_llm_key_gate.md` |
| Knowledge Base | `03_knowledge_base.md` |
| RAG Ingest Pipeline | `04_rag_ingest_pipeline.md` |
| LLM Router | `05_llm_router.md` |
| Allocation Guard | `06_allocation_guard.md` |
| API: Research Ticker | `07_api_research_ticker.md` |
| API: Knowledge Ingest | `08_api_knowledge_ingest.md` |
| API: Knowledge Upload | `09_api_knowledge_upload.md` |
| API: Knowledge Corpus Size | `10_api_knowledge_corpus_size.md` |
| Research Hub Client | `11_research_hub_client.md` |
| Research Header | `12_research_header.md` |
| Sentiment Card | `13_sentiment_card.md` |
| Risk Factors Card | `14_risk_factors_card.md` |
| Narrative Summary Card | `15_narrative_summary_card.md` |
| Disclaimer Banner | `16_disclaimer_banner.md` |
| AI Insight Tag | `17_ai_insight_tag.md` |
