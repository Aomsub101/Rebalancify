...
**Active Story:** STORY-011 — Rebalancing wizard execute API route (Alpaca + manual)
**Last Completed:** STORY-010b — Rebalance calculator (full mode, pre-flight, cash injection) (2026-03-28)
