/**
 * app/api/backfill_debut/route.ts
 * Next.js proxy route — forwards /api/backfill_debut requests to the Railway FastAPI service.
...
export async function POST(request: Request) {
  ...
  const response = await fetch(`${railwayUrl}/backfill_debut`, {
    method: "POST",
    headers: {
